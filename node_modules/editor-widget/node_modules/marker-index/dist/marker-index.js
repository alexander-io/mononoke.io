...
var MarkerIndex = (function () {
  ...
  _createClass(MarkerIndex, [{
    ...
    key: 'findStartingAt',
    value: function findStartingAt(offset) {
      return this.findStartingIn(offset, offset);
    }
  }, {
    key: 'findEndingAt',
    value: function findEndingAt(offset) {
      return this.findEndingIn(offset, offset);
    }
  }, {
    key: 'getNodeOffset',
    value: function getNodeOffset(node) {
      var offset = node.leftExtent;
      while (node.parent) {
        if (node.parent.right === node) {
          offset = (0, _pointHelpers.traverse)(node.parent.leftExtent, offset);
        }
        node = node.parent;
      }
      return offset;
    ...
    value: function rotateNodeRight(pivot) {
      ...
      root.leftMarkerIds.forEach(function (markerId) {
        if (!pivot.startMarkerIds.has(markerId)) {
          // don't do this when pivot is at offset 0
