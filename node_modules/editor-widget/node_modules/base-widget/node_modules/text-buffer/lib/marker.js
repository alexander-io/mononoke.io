(function() {
  var Delegator, Emitter, Marker, OptionKeys, Point, Range, extend, isEqual, omit, pick, size, _ref;
  ...
  module.exports = Marker = (function() {
    ...
    function Marker(id, layer, range, params) {
      ...
      this.layer.setMarkerHasTail(this.id, this.tailed);
    }
    ...
    Marker.prototype.onDidChange = function(callback) {
      if (!this.hasChangeObservers) {
        ...
        this.layer.markersIdsWithChangeSubscriptions.add(this.id);
      }
    ...
    Marker.prototype.getRange = function() {
      var _ref1;
      return (_ref1 = this.rangeWhenDestroyed) != null ? _ref1 : this.layer.getMarkerRange(this.id);
    };
    ...
    Marker.prototype.getStartPosition = function() {
      var _ref1, _ref2;
      return (_ref1 = (_ref2 = this.rangeWhenDestroyed) != null ? _ref2.start : void 0) != null ? _ref1 : this.layer.getMarkerStartPosition(this.id);
    };

    Marker.prototype.getEndPosition = function() {
      var _ref1, _ref2;
      return (_ref1 = (_ref2 = this.rangeWhenDestroyed) != null ? _ref2.end : void 0) != null ? _ref1 : this.layer.getMarkerEndPosition(this.id);
    };
    ...
    Marker.prototype.destroy = function() {
      ...
      this.layer.destroyMarker(this.id);
