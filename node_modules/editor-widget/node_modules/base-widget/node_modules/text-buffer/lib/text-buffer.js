(function() {
  var CompositeDisposable, Emitter, File, History, MarkerLayer, MatchIterator, Patch, Point, Range, SearchCallbackArgument, Serializable, SpanSkipList, TextBuffer, TransactionAbortedError, diff, fs, newlineRegex, path, spliceArray, _, _ref, _ref1,
  ...
  module.exports = TextBuffer = (function() {
    ...
    function TextBuffer(params) {
      var maxUndoEntries, text, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8;
      ...
      this.nextMarkerLayerId = (_ref5 = params != null ? params.nextMarkerLayerId : void 0) != null ? _ref5 : 0;
      this.defaultMarkerLayer = (_ref6 = params != null ? params.defaultMarkerLayer : void 0) != null ? _ref6 : new MarkerLayer(this, String(this.nextMarkerLayerId++));
      this.markerLayers = (_ref7 = params != null ? params.markerLayers : void 0) != null ? _ref7 : {};
      ...
      this.digestWhenLastPersisted = (_ref8 = params != null ? params.digestWhenLastPersisted : void 0) != null ? _ref8 : false;
    ...
    TextBuffer.prototype.deserializeParams = function(params) {
      var layerId, layerState, markerLayers, _ref2;
      markerLayers = {};
      _ref2 = params.markerLayers;
      for (layerId in _ref2) {
        layerState = _ref2[layerId];
    ...
    TextBuffer.prototype.serializeParams = function() {
      var id, layer, markerLayers, _ref2, _ref3;
      markerLayers = {};
      _ref2 = this.markerLayers;
      for (id in _ref2) {
        layer = _ref2[id];
      ...
      return {
        ...
        digestWhenLastPersisted: (_ref3 = this.file) != null ? _ref3.getDigestSync() : void 0,
    ...
    TextBuffer.prototype.applyChange = function(change, skipUndo) {
      var changeEvent, endRow, ending, id, lastIndex, lastLine, lastLineEnding, line, lineEndings, lineStartIndex, lines, markerLayer, newExtent, newRange, newText, normalizeLineEndings, normalizedEnding, normalizedNewText, offsets, oldExtent, oldRange, oldText, prefix, result, rowCount, startRow, suffix, _ref2, _ref3, _ref4;
      ...
      if (this.markerLayers != null) {
        oldExtent = oldRange.getExtent();
        newExtent = newRange.getExtent();
        _ref3 = this.markerLayers;
        for (id in _ref3) {
          markerLayer = _ref3[id];
    ...
    TextBuffer.prototype.markPosition = function(position, properties) {
      return this.defaultMarkerLayer.markPosition(position, properties);
    };
    ...
    TextBuffer.prototype.transact = function(groupingInterval, fn) {
      var checkpointBefore, endMarkerSnapshot, exception, result;
      ...
      this.history.groupChangesSinceCheckpoint(checkpointBefore, endMarkerSnapshot, true);
    ...
    TextBuffer.prototype.createMarkerSnapshot = function() {
      var markerLayer, markerLayerId, snapshot, _ref2;
      snapshot = {};
      _ref2 = this.markerLayers;
      for (markerLayerId in _ref2) {
        markerLayer = _ref2[markerLayerId];
    ...
    TextBuffer.prototype.restoreFromMarkerSnapshot = function(snapshot) {
      var layerSnapshot, markerLayerId, _results;
      _results = [];
      for (markerLayerId in snapshot) {
        layerSnapshot = snapshot[markerLayerId];
        _results.push(this.markerLayers[markerLayerId].restoreFromSnapshot(layerSnapshot));
      }
      return _results;
    };

    TextBuffer.prototype.emitMarkerChangeEvents = function(snapshot) {
      var markerLayer, markerLayerId, _ref2, _results;
      _ref2 = this.markerLayers;
      _results = [];
      for (markerLayerId in _ref2) {
        markerLayer = _ref2[markerLayerId];
        _results.push(markerLayer.emitChangeEvents(snapshot != null ? snapshot[markerLayerId] : void 0));
      }
      return _results;
    };
